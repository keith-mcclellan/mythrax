...
**Mythrax Git Commit:** `ddbf2d0336ccb539c12905ca8471e31591647ab6`
**Evaluated at:** 2026-06-29T22:59:09.722803+00:00
...
- **Recall_Any@5 (session):** `0.0000`
- **Recall_All@5 (session):** `0.0000`

## Per-Question-Type R@10 (turn recall_any)
- **knowledge-update** (n=78): R@10 = `0.0000`
- **multi-session** (n=133): R@10 = `0.0000`
- **single-session-assistant** (n=56): R@10 = `0.0000`
- **single-session-preference** (n=30): R@10 = `0.0000`
- **single-session-user** (n=70): R@10 = `0.0000`
- **temporal-reasoning** (n=133): R@10 = `0.0000`
